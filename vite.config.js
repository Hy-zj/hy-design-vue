 ...
 * @LastEditTime: 2023-08-15 13:49:28
 */
...
console.log(resolve(__dirname, 'pageages/index.js'))
...
export default defineConfig({
  ...
  build: {
    lib: { // 构建为库。如果指定了 build.lib，build.cssCodeSplit 会默认为 false。
      ...
      name: 'HyDesignVue', // 暴露的全局变量
      fileName: 'hy-design-vue' // 输出的包文件名，默认是package.json的name选项
    },
